function [ valid_value ] = RadDecoderTimerNumberCount( input, number_code_in, code_temp_in )
   % input = [6 3 2 6 3];
    ...
    for number_time = 1:5
        if(error == 0) 
            ...
            if(code3(step_save(1), number_time) == 0) | ( code3(step_save(2), number_time) == 0)
                error = 0;
                output(number_time) = 3 - number_code;
                if number_code == 1
                    number_code = 3;
                else
                ...
                if code3(step_save(1), number_time) == 0
                    ...
                    valid_value(number_time) = output(number_time);
                    switch step_save(1)
                        case 4  
                            step_save = [4 3 2 1];
                        case 3
        ...
        elseif error == 1
            ...
            if(code3(step_save(1), number_time) == 0) | ( code3(step_save(2), number_time) == 0 | code3(step_save(3), number_time) == 0) | ( code3(step_save(4), number_time) == 0)
                error = 0;
                output(number_time) = 3 - number_code;
                output(number_time - 1) = 3 - number_code_save;
                number_code_save = 55;
                if number_code == 1
                    number_code = 3;
                else
                ...
                if code3(step_save(1), number_time) == 0
                    code_temp(1) =  code(step_save(1), number_time);
                    valid_value(number_time) =  output(number_time);
                    valid_value(number_time-1) = output(number_time - 1);
                    switch step_save(1)
                        case 4  
                            step_save = [4 3 2 1];
                        case 3                        
